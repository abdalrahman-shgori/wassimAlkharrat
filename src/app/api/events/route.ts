...
export async function POST(request: NextRequest) {
  try {
    ...
    const newEvent: any = {
      ...
      hostOpinionEn: body.hostOpinionEn || null,
      hostOpinionAr: body.hostOpinionAr || null,
      hostOpinionImage: body.hostOpinionImage || null,
      hostNameEn: body.hostNameEn || null,
      hostNameAr: body.hostNameAr || null,
      hostRoleEn: body.hostRoleEn || null,
      hostRoleAr: body.hostRoleAr || null,
